locals {
  ...
  ec2_instances_large_allowed_types_enum    = ["%.nano", "%.micro", "%.small", "%.medium", "%.large", "%.xlarge", "%._xlarge"]
  ec2_instances_large_default_action_enum   = ["notify", "skip", "stop_instance", "terminate_instance"]
  ec2_instances_large_enabled_actions_enum  = ["skip", "stop_instance", "terminate_instance"]
}
...
pipeline "detect_and_correct_ec2_instances_large" {
  ...
  param "default_action" {
    ...
    enum        = local.ec2_instances_large_default_action_enum
  }
