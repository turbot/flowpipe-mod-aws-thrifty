locals {
  ...
  ec2_gateway_load_balancers_if_unused_default_action_enum  = ["notify", "skip", "delete_load_balancer"]
  ec2_gateway_load_balancers_if_unused_enabled_actions_enum = ["skip", "delete_load_balancer"]
}
...
trigger "query" "detect_and_correct_ec2_gateway_load_balancers_if_unused" {
  ...
  documentation = file("./pipelines/ec2/docs/detect_and_correct_ec2_gateway_load_balancers_if_unused_trigger.md")
...
pipeline "detect_and_correct_ec2_gateway_load_balancers_if_unused" {
  title         = "Detect & correct EC2 gateway load balancers if unused"
  description   = "Detects unused EC2 gayeway load balancers and runs your chosen action."
  documentation = file("./pipelines/ec2/docs/detect_and_correct_ec2_gateway_load_balancers_if_unused.md")
  ...
  param "default_action" {
    ...
    enum        = local.ec2_gateway_load_balancers_if_unused_default_action_enum
  }
  ...
  param "enabled_actions" {
    ...
    enum        = local.ec2_gateway_load_balancers_if_unused_enabled_actions_enum
  }
...
pipeline "correct_ec2_gateway_load_balancers_if_unused" {
  ...
  documentation = file("./pipelines/ec2/docs/correct_ec2_gateway_load_balancers_if_unused.md")
...
pipeline "correct_one_ec2_gateway_load_balancer_if_unused" {
  ...
  documentation = file("./pipelines/ec2/docs/correct_one_ec2_gateway_load_balancer_if_unused.md")
  tags          = merge(local.ec2_common_tags, { class = "unused", folder = "Internal" })
