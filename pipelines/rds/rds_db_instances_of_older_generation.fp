locals {
  ...
  rds_db_instances_of_older_generation_default_action_enum  = ["notify", "skip", "delete_instance"]
  rds_db_instances_of_older_generation_enabled_actions_enum = ["skip", "delete_instance"]
}
...
pipeline "detect_and_correct_rds_db_instances_of_older_generation" {
  ...
  param "default_action" {
    ...
    enum        = local.rds_db_instances_of_older_generation_default_action_enum
  }
  ...
  param "enabled_actions" {
    ...
    enum        = local.rds_db_instances_of_older_generation_enabled_actions_enum
  }
...
pipeline "correct_rds_db_instances_of_older_generation" {
  ...
  tags          = merge(local.rds_common_tags, { class = "deprecated", folder = "Internal" })
