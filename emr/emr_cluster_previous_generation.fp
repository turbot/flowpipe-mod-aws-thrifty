// locals {
//   emr_clusters_older_generation_query = <<-EOQ
//     select
//       concat(ig.cluster_id, ' [', ig.region, '/', ig.account_id, ']') as title,
//       ig.region,
//       ig._ctx ->> 'connection_name' as cred
//     from
//       aws_emr_instance_group as ig,
//       aws_emr_cluster as c
//     where
//       ig.cluster_id = c.id
//       and ig.state != 'TERMINATED'
//       and ig.instance_group_type = 'MASTER'
//       and ig.instance_type like any (array[${join(",", formatlist("'%s'", var.emr_cluster_previous_generation))}])
//   EOQ
// }
...
//     default     = var.emr_cluster_previous_generation_enabled_response_options
//   }
