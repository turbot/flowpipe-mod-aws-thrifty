locals {
  ec2_gateway_load_balancers_unused_query = <<-EOQ
...
trigger "query" "detect_and_correct_ec2_gateway_load_balancers_unused" {
  ...
  sql      = local.ec2_gateway_load_balancers_unused_query
...
pipeline "correct_ec2_gateway_load_balancers_unused" {
  ...
  step "pipeline" "correct_item" {
    ...
    pipeline        = pipeline.correct_one_ec2_gateway_load_balancer_unused
    args            = {
...
pipeline "correct_one_ec2_gateway_load_balancer_unused" {
