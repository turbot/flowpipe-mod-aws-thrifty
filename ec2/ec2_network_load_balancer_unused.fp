...
pipeline "detect_and_respond_to_ec2_network_load_balancer_unused" {
  ...
  documentation = file("./ec2/ec2_network_load_balancer_unused.md")
...
pipeline "respond_to_ec2_network_load_balancers_unused" {
  title         = "Respond to EC2 network load balancers exceeding max age"
  description   = "Responds to a collection of EC2 network load balancers exceeding max age."
  documentation = file("./ec2/ec2_network_load_balancer_unused.md")
  // tags          = merge(local.ec2_common_tags, { 
  //   class = "deprecated" 
  // })
  ...
  param "default_response" {
    type        = string
    description = local.DefaultResponseDescription
    default     = var.ec2_network_load_balancer_unused_default_response
  }

  param "responses" {
    type        = list(string)
    description = local.ResponsesDescription
    default     = var.ec2_network_load_balancer_unused_responses
  }
