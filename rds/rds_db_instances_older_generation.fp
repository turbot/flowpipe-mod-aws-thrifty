...
trigger "query" "detect_and_respond_to_rds_db_instances_older_generation" {
  title       = "Detect and respond to older generation RDS DB instances"
  description = "Detects older generation RDS DB instances and responds with your chosen action."
  ...
  capture "insert" {
    pipeline = pipeline.respond_to_rds_db_instances_older_generation
    args = {
...
pipeline "detect_and_respond_to_rds_db_instances_older_generation" {
  title       = "Detect and respond to older generation RDS DB instances"
  description = "Detects older generation RDS DB instances and responds with your chosen action."
  ...
  param "default_response_option" {
    ...
    default     = var.rds_db_instance_older_generation_default_response_option
  }

  param "enabled_response_options" {
    type        = list(string)
    description = local.ResponsesDescription
    default     = var.rds_db_instance_older_generation_enabled_response_options
  }
...
pipeline "respond_to_rds_db_instances_older_generation" {
  title       = "Respond to older generation RDS DB instances"
  description = "Responds to a collection of older generation RDS DB instances."
  ...
  step "pipeline" "respond_to_item" {
    ...
    pipeline        = pipeline.respond_to_rds_db_instance_older_generation
    args = {
...
pipeline "respond_to_rds_db_instance_older_generation" {
  title       = "Respond to older generation RDS DB instance"
  description = "Responds to a older generation RDS DB instance."
